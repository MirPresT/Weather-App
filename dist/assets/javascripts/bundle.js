...
/******/ 	var hotCurrentHash = "ccba688e9c593cb575b7"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(__webpack_require__(9)){
	  var LIBRARY             = __webpack_require__(48)
	    ...
	    , arrayCopyWithin     = __webpack_require__(84)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loadApp2 = __webpack_require__(208);
	...
	var index = {
	  ...
	  loadApp: function loadApp(position) {
	    ...
	    (0, _loadApp2.loadApp)(position);
	  },
	  insertLoadSpinner: function insertLoadSpinner() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadApp(position) {
	  ...
	  var app = {
	    ...
	    switchTemps: function switchTemps(temp) {
	    ...
	    toCelcius: function toCelcius(val) {
	    ...
	    updateProgress: regeneratorRuntime.mark(function updateProgress() {
	      var progress, counter;
	      return regeneratorRuntime.wrap(function updateProgress$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            ...
	            case 2:
	              ...
	              counter++;
	              _context.next = 7;
	              return this.progressBar.MaterialProgress.setProgress(progress);
	    ...
	    setInfoTab: function setInfoTab(data) {
	      ...
	      var infoToPlace = [Math.round(windSpeed) + '<span id="mph">mph</span>', Math.round(humidity * 100) + '<span id="percent">%</span>', _moment2.default.unix(sunriseTime).format('h:mm') + '<span id="period">am</span>', _moment2.default.unix(sunsetTime).format('h:mm') + '<span id="period">pm</span>'];
	      var counter = 0;
	      ...
	      for (var i = 0; i < dayElems.length; i++) {
	        ...
	        for (var x = 0; x < boxes.length; x++) {
	          ...
	          if (box.classList.contains('box-date')) {
	            ...
	            box.children[0].innerHTML = _moment2.default.unix(unixTime).format('ddd Do');
	          }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperty = __webpack_require__(382)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(17)([].indexOf), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(17)([].lastIndexOf), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S, 'Math', {expm1: __webpack_require__(71)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(9), 'Object', {defineProperties: __webpack_require__(97)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global     = __webpack_require__(5)
	  , $export    = __webpack_require__(1)
	  , invoke     = __webpack_require__(53)
	  , partial    = __webpack_require__(215)
